  ...
  if (links.length === 0) {
    return (
      <div className="text-center py-20">
        <div className="text-slate-300 h-16 mx-auto">
      ...
      {links.map((link, index) => (
        ...
        >
          <div
            ...
            hover:border-slate-300/50 rounded-2xl p-6 transition-all duration-300
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-gradient-to-r  *:
                from-blue-50/0 via-purple-50/0 to-blue-50/0 
                group-hover:from-blue-50/30 group-hover:via-purple-50/20 group-hover:to-blue-50/30
            ...
            <div className="relative flex items-center justify-between">
              ...
              <div
                className="ml-4 text-slate-400 group-hover:text-slate-600 transition-all duration-200

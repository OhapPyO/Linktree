...
function LinkAnalytics({ analytics, hasAnalyticsAccess }: LinkAnalyticsProps) {
    ...
    return (
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
        <div className="max-w-7xl mx-auto">
          <div
            className="bg-white/88 backdrop-blur-sm border-2 border-dashed border-gray-300
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Upgrade to unlock pwerful insights
                </p>
              </div>
            </div>
            <div className=" mt-6 space-x-6">
              ...
              <div className="flex items-center gap-4 text-gray-600">
                ...
                <span>See geographic distrbution</span>
              </div>
            </div>
            <div className="mt-8 bg-gray-50 rounded-lg p-4 text-center">
              ...
              <Link
                ...
                className="inline-block mt-4 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white
  ...
  return (
    <div>
      ...
      {/* Daily Performacne chart*/}
      {analytics.dailyData.length > 0 && (
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
          <div className="max-w-7xl mx-auto">
            <div
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-slate-500 rounded-xl">
                  <BarChart3 className="w-6 h-6 text-white"></BarChart3>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">
                    Daily Performance
      ...
      <Protect
        ...
        fallback={
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
            <div className="max-w-7xl mx-auto">
              <div
                className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 shadow-xl 
                shadow-gray-200/50"
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-gray-400 rounded-xl">
      ...
      {analytics.dailyData.length === 0 && (
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
          <div className="max-w-7xl mx-auto">
            <div
              className="bg-white/8- backdrop-blur-sm border border-white/20
                rounded-2xl shadow-xl shadow-gray-200/50 text-center"
            >
              ...
              <p className="text-gray-600">
                Analytics will appear here once this links starts receving
                clicks
              </p>
            </div>
          </div>

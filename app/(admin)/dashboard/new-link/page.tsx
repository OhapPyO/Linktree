...
async function NewLinkPage() {
  ...
  //   const hasTenLinkCapacity = has({ plan: "pro" });
  //   const hasUnlimitedLinks = has({ plan: "ultra" });

  const linkCount = await fetchQuery(api.lib.links.getLinksCountByUserId, {
    userId: userId || "",
  });
  ...
  if (!access.canCreate) {
    return (
      <div
        className="min-h-screen bg-gradient-to-br from-gray-50
       to-gray-100 p-4 lg:p-8"
      >
        <div className="max-w-7xl mx-auto">
          <div
            className="bg-white/80 backdrop-blur-sm border
             border-white/20 rounded-2xl p-8 shadow-xl
             shadow-gray-200/50 "
          >
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 text-purple-600/75 hover:text-purple-900
    ...
    <>
      <div className="mb-6">
        <Link
         ...
         text-purple-600/75 hover:text-purple-900
        transition-colors font-medium"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to My Links
              ...
              <div className="space-y-6">
                <div>
                 ...
                 leading-tight"
                  ...
                  <div
                    className="w-20 h-1 bg-gradient-to-r from-blue-500 
                  to-purple-600 rounded-full mt-4"
                  ></div>
                </div>
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-gray-500">
                    Fill in the information to create your link.{" "}
                  </p>
                </div>
                <CreateLinkForm />
              </div>

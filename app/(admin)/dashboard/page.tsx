...
async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <Protect
        feature="access_to_analytics"
        fallback={
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8 mb-8">
            <div className="max-w-7xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-340 rounded-2xl p-8 shadow-xl shadow-gray200/50">
                ...
                <div className="mt-4 flex items-center">
                  <div className="bg-gray-100 rounded-lg [-4 text-center w-full">
      ...
      >
        <DashboardMetric analytics={analytics} />
      </Protect>
